  ...
  return (
    <section id="footer" className="relative flex flex-col items-center justify-center">
      ...
      <img
        src={bGrassDesk}
        alt="Bottom Grass Part"
        className="absolute h-auto w-full -top-44 hidden md:block"
      />
      <img src={AiDog} alt="mountain-clif-small"  className='w-48 absolute -top-52 right-5 sm:w-56 lm:right-32'/>
      <div className="flex flex-col absolute items-center justify-center lm:flex-row lm:justify-between lm:w-full">
        <div className="">
          <img src={img} alt="" className=" w-auto h-32 sm:h-48 lm:ml-6" />
        </div>

        <p className="pt-12 text-slate-200 lm:mr-6">
