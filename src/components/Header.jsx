...
async function connectAccount() {
  ...
  return (
    <>
      {/* //   <!-- Nav Container --> */}
      <div className="md:w-full lg:w-full bg-[#52bbe8] relative">
        <nav className="relative container mx-auto p-6">
          ...
          <div className="flex items-center justify-between">
              ...
              <div className="hidden space-x-8 font-bold lg:flex items-center md:hidden lg:overflow-clip">
                ...
                >
                  <button className="flex flex-col items-center group">
                    <svg
                      className="fill-slate-800 group-hover:fill-amber-800 mb-1 bi bi-controller"
                    ...
                    <span className="text-slate-800 group-hover:text-amber-800">
                      Play Game
                    </span>
                  </button>
                </a>
                <a
                  href="/#"
                  className="text-grayishViolet hover:text-amber-800 px-3"
                >
                  <button className="flex flex-col items-center group">
                    <svg
                      className="fill-slate-800 group-hover:fill-amber-800 mb-1 bi bi-newspaper"
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
                      fill="currentColor"
                ...
                >
                  <button className="flex flex-col items-center group" onClick={scrollToRoadmap}>
                    <svg
                      className="fill-slate-800 group-hover:fill-amber-800 mb-1 bi bi-map"
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
                      fill="currentColor"
                ...
                <a
                  href="/#"
                  className="text-grayishViolet hover:amber-800 px-3"
                >
                  <button className="flex flex-col items-center group">
                    <svg
                      className="fill-slate-800 group-hover:fill-amber-800 mb-1 bi bi-wallet"
                      xmlns="http://www.w3.org/2000/svg"
                      width="21"
                      height="21"
                      fill="currentColor"
                ...
                >
                  <button className="flex flex-col items-center group">
                    <svg
                      className="fill-slate-800 group-hover:fill-amber-800 mb-1 bi bi-shop-window"
                      xmlns="http://www.w3.org/2000/svg"
                      width="21"
                      height="21"
                      fill="currentColor"
                ...
                >
                  <button className="flex flex-col items-center group" >
                    <svg
                      className="fill-slate-800 group-hover:fill-amber-800 mb-1 bi bi-coin"
                      xmlns="http://www.w3.org/2000/svg"
                      width="21"
                      height="21"
                      fill="currentColor"
                ...
                >
                  <button className="flex flex-col items-center group">
                    <svg
                      className="fill-slate-800 group-hover:fill-amber-800 mb-1 bi bi-share-fill"
                      xmlns="http://www.w3.org/2000/svg"
                      width="21"
                      height="21"
                      fill="currentColor"
            ...
            {/* <!-- Right Buttons Menu --> */}
            <button className="hidden mx-auto items-center space-x-6 font-bold lg:flex lg:overflow-clip" onClick={requestAccount}>
              <p
                className="px-8 py-3 font-bold text-white bg-amber-800 rounded-full hover:opacity-70"
              >
                {walletAddress.length === 0 ? "Connect Wallet" : truncateEthAddress(String(walletAddress))}
              </p>
            </button>
