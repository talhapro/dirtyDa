...
const NftTokenDetails = () => {
  return (
    ...
    <img src={BMountain} alt="mountain-clif"  className='w-[500px]  absolute -top-40 -left-5 sm:-top-80 sm:w-auto lm:w-[500px] lm:-top-[660px]'/>
    <img src={PugDog} alt="Pug Dog Gif" className='absolute w-44 -top-64 left-20 sm:-top-[420px] sm:w-56 lm:-top-[790px]'/>
    <img src={SMountain} alt="mountain-clif-small"  className='w-[120px]  absolute top-[260px] right-12 sm:w-[160px] sm:right-16 sm:top-64 lm:-top-48 lm:right-32'/>
    <img src={MMountain} alt="mountain-clif-small"  className='w-[480px]  absolute -bottom-2 sm:right-0 lm:w-[1050px]'/>
    <img src={AiDog} alt="mountain-clif-small"  className='absolute w-40 bottom-28 right-0 sm:bottom-36 sm:right-2 sm:w-52 lm:bottom-[350px] lm:right-36 lm:w-60'/>
    <div className="flex flex-col px-5 mt-36 absolute top-[340px] text-center lm:-top-14">
          ...
          <p className="mt-4 text-slate-800 font-bold text-lg text-left tracking-wider sm:max-w-2xl sm:text-center">
